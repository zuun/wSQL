...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
      ...
      protected void WQLAutoIndentNeeded(object sender, AutoIndentEventArgs args)
      {
         //block {}
         if (Regex.IsMatch(args.LineText, @"^[^""']*\{.*\}[^""']*$"))
            return;
      ...
      protected void InitWQLRegex()
      {
         ...
         CSharpKeywordRegex =
             new Regex(
                 @"\b(var|set|load|declare|find|map|flatten|print|ToString)\b|#region\b|#endregion\b",
                 RegexCompiledOption);
      }
...
";
      ...
      /// </summary>
      /// <param name="range"></param>
      public virtual void WQLSyntaxHighlight(Range range)
      {
         range.tb.CommentPrefix = "//";
         range.tb.LeftBracket = '(';
         range.tb.RightBracket = ')';
